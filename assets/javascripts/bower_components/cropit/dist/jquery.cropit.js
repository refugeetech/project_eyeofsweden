	  ...
	  _createClass(Cropit, [{
	    ...
	    value: function onImageLoaded() {
	      ...
	      if (this.options.imageState && this.options.imageState.offset) {
			...
			//set minzoom
			this.initZoom = true;
			this.zoomer.minZoom=0.2;
			this.$zoomSlider.val(this.zoomer.minZoom)
			//adjust slider without triggering onchange
	    ...
	    value: function onZoomSliderChange() {
			...
			if (this.initZoom && Number(this.$zoomSlider.val()) == this.zoomer.minZoom) {
				return;
			} else {
				this.initZoom = false;
			}
